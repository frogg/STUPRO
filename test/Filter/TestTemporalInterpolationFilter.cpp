...
TEST(TestTemporalInterpolationFilter, TestWindData) {
	...
	QList<Vector3<float>> windVelocitiesOfFirstPoint = QList<Vector3<float>>() << Vector3<float>(0.0052335961, 0.099862956, 0) << Vector3<float>(1.3167129, -0.85508329, 0) << Vector3<float>(-0.027239431, -0.053460389, 0) << Vector3<float>(-1.5553, 0.3306, 0);
	...
	QList<Vector3<float>> windVelocitiesOfSecondPoint = QList<Vector3<float>>() << Vector3<float>(-0.49950644, 0.66286749, 0) << Vector3<float>(-0.49950644, 0.66286749, 0) << Vector3<float>(-0.49950644, 0.66286749, 0) << Vector3<float>(-0.49950644, 0.66286749, 0);
	...
	for (int t = 0; t < windSpeedsOfFirstPoint.size() - 1; t++) {
		...
		// Extract the filter's output
		vtkSmartPointer<vtkFloatArray> windSpeedArray = vtkFloatArray::SafeDownCast(outputDataSet->GetPointData()->GetArray("speeds"));
		ASSERT_TRUE(windSpeedArray);
		
		vtkSmartPointer<vtkFloatArray> windBearingArray = vtkFloatArray::SafeDownCast(outputDataSet->GetPointData()->GetArray("directions"));
		ASSERT_TRUE(windBearingArray);
		
		vtkSmartPointer<vtkFloatArray> windVelocityArray = vtkFloatArray::SafeDownCast(outputDataSet->GetPointData()->GetArray("velocity"));
