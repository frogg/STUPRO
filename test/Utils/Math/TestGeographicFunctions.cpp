...
TEST(TestGeographicFunctions, TestGreatCircleDistance) {
	...
	EXPECT_NEAR(KRONOS_PI * earthRadius, calculateDistance(Coordinate(90, 0), Coordinate(-90, 0)), acceptableError);
	
	// Some standard distance calculations
	EXPECT_NEAR(1359.638, calculateDistance(Coordinate(50.0, 20.0), Coordinate(40.0, 30.0)), acceptableError);
	EXPECT_NEAR(15.602, calculateDistance(Coordinate(10.3, 15.2), Coordinate(10.4, 15.1)), acceptableError);
	...
	EXPECT_NEAR(17830.350, calculateDistance(Coordinate(80, 170), Coordinate(-80, -170)), acceptableError);
}
