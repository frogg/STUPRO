...
void TestImageDownloadWorker::testDownload() {
	QUrl imgUrl("http://worldwind26.arc.nasa.gov/wms?service=WMS&request=GetMap&version=1.3.0&crs=CRS:84&layers=NASA_SRTM30_900m_Tiled,aster_v2,USGS-NED&styles=&format=image/jpeg&width=512&height=512&bbox=-90,-180,-89.9973,-179.997");
