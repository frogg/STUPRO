#include <Filter/CLaMSAltitudeFilter.h>
...
vtkStandardNewMacro(CLaMSAltitudeFilter);

CLaMSAltitudeFilter::CLaMSAltitudeFilter() { };
//CLaMSAltitudeFilter::CLaMSAltitudeFilter() : error(false) { }

CLaMSAltitudeFilter::~CLaMSAltitudeFilter() { }


void CLaMSAltitudeFilter::fail(QString message) {
...
int CLaMSAltitudeFilter::RequestData(vtkInformation* info,
...
int CLaMSAltitudeFilter::RequestInformation(vtkInformation* request,
        vtkInformationVector** inputVector,
        vtkInformationVector* outputVector) {
	return 1;
}

void CLaMSAltitudeFilter::setLower(float lowerLimit) {
	this->LowerLimit = lowerLimit;
	this->Modified();
}

void CLaMSAltitudeFilter::setUpper(float upperLimit) {
...
void CLaMSAltitudeFilter::PrintSelf(ostream& os, vtkIndent indent) {
	this->Superclass::PrintSelf(os, indent);
	os << indent << "Filter for selecting and extracting certain data points, Kronos Project" <<
	   endl;
}
void CLaMSAltitudeFilter::SetInputConnection(vtkAlgorithmOutput* input) {
	this->Superclass::SetInputConnection(input);
}

int CLaMSAltitudeFilter::FillOutputPortInformation(int port, vtkInformation* info) {
	info->Set(vtkDataObject::DATA_TYPE_NAME(), "vtkPolyData");
	return 1;
}

int CLaMSAltitudeFilter::FillInputPortInformation(int port, vtkInformation* info) {
	if (port == 0) {
...
bool CLaMSAltitudeFilter::evaluatePoint(int pointIndex, Coordinate coordinate,
	...
	return (this->LowerLimit <= altitude && altitude <= this->UpperLimit);
}
