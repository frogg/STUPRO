...
private:
    ...
    void interpolateDataPoint(TemporalDataPoint lower, TemporalDataPoint higher, int distanceToFirstInterpolationTimestep, int index, PointCoordinates coordinate, int distance);
