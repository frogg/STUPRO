 ...
 */
class AIRSAshFilter : public vtkDataObjectAlgorithm {
public:

    vtkTypeMacro(AIRSAshFilter, vtkDataObjectAlgorithm)
    static AIRSAshFilter *New();
...
private:
	...
	AIRSAshFilter(const AIRSAshFilter&);  // Not implemented.
	void operator=(const AIRSAshFilter&);  // Not implemented.
