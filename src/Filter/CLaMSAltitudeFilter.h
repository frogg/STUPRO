 ...
 */
class CLaMSAltitudeFilter : public vtkDataObjectAlgorithm {
public:

    vtkTypeMacro(CLaMSAltitudeFilter, vtkDataObjectAlgorithm)
    static CLaMSAltitudeFilter *New();
...
private:
	...
	CLaMSAltitudeFilter(const CLaMSAltitudeFilter&);  // Not implemented.
	void operator=(const CLaMSAltitudeFilter&);  // Not implemented.
