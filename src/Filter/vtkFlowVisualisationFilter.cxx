/**
*/
#include "vtkFlowVisualisationFilter.h"
...
vtkStandardNewMacro(vtkFlowVisualisationFilter);

int vtkFlowVisualisationFilter::RequestData(
...
int vtkFlowVisualisationFilter::ProcessRequest(
...
void vtkFlowVisualisationFilter::switchVisualisationMethod(int method) {
	currentMethod = static_cast<VisualisationMethod>(method);
	vtkWarningMacro(<< " CHANGED currentMethod TO " << method);
}

void vtkFlowVisualisationFilter::PrintSelf(ostream& os, vtkIndent indent) {
	this->Superclass::PrintSelf(os, indent);

	os << indent << "Hello, this is our filter." << endl;
	os << indent << "Current method: " << currentMethod << endl;
}
