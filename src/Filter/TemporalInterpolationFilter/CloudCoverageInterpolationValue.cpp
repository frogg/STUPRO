...
CloudCoverageInterpolationValue::CloudCoverageInterpolationValue(int priority, int timestamp, float cloudCoverage) : InterpolationValue(priority, timestamp), cloudCoverage(cloudCoverage) { }
