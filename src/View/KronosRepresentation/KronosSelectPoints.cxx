...
int KronosSelectPoints::RequestData(
...
unsigned long int KronosSelectPoints::GetMTime()
{
...
int KronosSelectPoints::FillInputPortInformation(int, vtkInformation *info)
{
  info->Set(vtkAlgorithm::INPUT_REQUIRED_DATA_TYPE(), "vtkDataSet");
  return 1;
}

void KronosSelectPoints::PrintSelf(ostream& os, vtkIndent indent)
{
...
float * KronosSelectPoints::Initialize(bool getZbuff)
{
...
bool KronosSelectPoints::IsPointOccluded(
  const double x[3],
  const float *zPtr
  )
{
  ...
  if (view[3] == 0.0)
    {
        ...
        this->Renderer->SetViewPoint(view[0], view[1], view[2]);
