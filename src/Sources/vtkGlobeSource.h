...
=========================================================================*/
// .NAME vtkGlobeSource - create a polygonal sphere centered at the origin
// .SECTION Description
// vtkGlobeSource creates a sphere (represented by polygons) of specified
...
class VTKFILTERSSOURCES_EXPORT vtkGlobeSource : public vtkPolyDataAlgorithm
{
public:
